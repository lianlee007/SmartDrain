/**
 * Autenticación en el cliente: registro, login y persistencia de sesión.
 * Delega credenciales al API; guarda usuario en sessionStorage y opcionalmente localStorage.
 */
...
export const ServicioAuth = {
  /** Comprueba si el correo ya está registrado (excluye usuario anónimo). */
  ...
  /** Guarda sesión activa; si recordar=true, replica en localStorage. */
  ...
  /** Restaura usuario desde sesión o, si marcó recordar, desde localStorage. */
