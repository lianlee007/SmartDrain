...
/** Perfil hidrológico por nodo (Popayán: zonas bajas vs lomas) */
...
/**
 * Actualización de telemetría por lectura.
 * Normal: variación operativa. Alerta meteorológica: subidas en zonas sensibles.
 */
