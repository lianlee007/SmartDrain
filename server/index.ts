/**
 * Servidor Express de SmartDrain: API REST sobre MySQL.
 * Expone salud, autenticación, reportes ciudadanos y telemetría IoT simulada.
 */
...
app.use(cors());
app.use(express.json({ limit: '15mb' })); // fotos en base64 en reportes
...
// Formas de filas MySQL (snake_case) antes de mapear al dominio
...
/** Convierte fila SQL a tipo Reporte del frontend (camelCase, ISO fecha). */
...
app.post('/api/auth/login', async (req, res) => {
  try {
    ...
    // Migración transparente: texto plano → bcrypt en el siguiente login válido
...
// --- Sensores IoT (simulación en cada GET) ---
